"""
Aplicação Streamlit Refatorada - Target AI Agent v0.60
...
# Page configuration
st.set_page_config(page_title="Agente IA Target v0.60", page_icon="🤖", layout="wide")
...
def _render_header():
    ...
    st.markdown(
        ...
        <div class="header-container">
            <h1 class="app-title">🤖 AGENTE IA TARGET v0.60</h1>
...
def _prepare_visualization_data(df_result, is_temporal_hint=False, user_prompt="", last_query=None):
    ...
    # IMPORTANTE: Verificar is_grouped_comparison ANTES de is_temporal para dar prioridade
    if is_grouped_comparison:
        # NOVO: Usar gráfico de barras verticais agrupadas
    ...
    if is_grouped_comparison:
        # NOVO: Comparação grupal - formato especial com group, category, value
