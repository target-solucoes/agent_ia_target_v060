...
""",
        "correto": """
### 💡 Principais Insights
- **Concentração significativa**: Os top 3 clientes representam 71% do volume total dos 5 principais
- **Cliente líder destaca-se**: Primeira posição com 38M unidades equivale a 37% do top 5
- **Gap expressivo**: Diferença de 17M unidades entre 1º e 2º colocado indica forte liderança consolidada
"""
    },
...
""",
        "correto": """
### 💡 Principais Insights
- **SC lidera com 43% do total de vendas**, superando RS em +12 p.p. e PR em +19 p.p.
- **Concentração parcial**: RS e PR combinados representam 57% do total, indicando que o mercado não está completamente monopolizado
- **Gap significativo**: SC vendeu R$ 1,2M a mais que a média dos outros dois estados (+115% acima da média regional)
"""
    },
...
""",
        "correto": """
### 💡 Principais Insights
- **Crescimento sustentado**: Tendência ascendente de 32% entre janeiro (R$ 1,8M) e dezembro (R$ 2,4M)
- **Sazonalidade marcada**: Picos em março (+15%), julho (+18%) e dezembro (+25%) coincidem com campanhas sazonais
- **Segundo semestre forte**: Concentra 58% do faturamento anual, sugerindo aceleração no H2
"""
    },
